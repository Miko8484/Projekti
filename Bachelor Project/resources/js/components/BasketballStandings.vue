                ...
                <table responsive aria-colcount="8" v-for="standing in standings['groups']" :key="standing.id"  class="table b-table table-hover border">
                    <thead class="groupStandingsTableHead">
                        <tr>
                            ...
                            <th v-b-tooltip.hover title="Winning percentage" aria-colindex="6" class="text-center groupTableHeader">W%</th>
                            <th v-b-tooltip.hover title="Games behind" aria-colindex="7" class="text-center groupTableHeader">GB</th>
                            <th v-b-tooltip.hover title="Win/lose streak" aria-colindex="8" class="text-center groupTableHeader">STRK</th>
                        </tr>
                    </thead>
                    <tbody class="">
                        <tr class="" v-for="group in standing" :key="group.id">
                            ...
                            <td aria-colindex="6" class="standings text-center">{{group.winPrct}}</td>
                            <td aria-colindex="7" class="standings text-center">{{group.gamesBehind}}</td>
                            <td aria-colindex="8" class="standings text-center">{{group.streak}}</td>
                        </tr>
                    </tbody>
                </table>
            </b-tab>
